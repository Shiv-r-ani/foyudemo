...
class PestControlActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupBookButton(R.id.bttn1, "Electricity", "Single Item Assembly", "₹299")
        setupBookButton(R.id.bttn2, "Electricity", "Room Setup",           "₹799")
        setupBookButton(R.id.bttn3, "Electricity", "Full Home Setup",      "₹1,999")
