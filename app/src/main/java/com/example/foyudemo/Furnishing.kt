...
class Furnishing : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_furnishing)

        setupBookButton(R.id.btn1111, "Furnishing", "Single Item Assembly", "₹299")
        setupBookButton(R.id.btn2222, "Furnishing", "Room Setup",           "₹799")
        setupBookButton(R.id.btn3333, "Furnishing", "Full Home Setup",      "₹1,999")
