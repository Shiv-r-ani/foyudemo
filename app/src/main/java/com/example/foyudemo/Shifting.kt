...
class Shifting : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupBookButton(R.id.btnn1, "Electricity", "Single Item Assembly", "₹299")
        setupBookButton(R.id.btnn2, "Electricity", "Room Setup",           "₹799")
        setupBookButton(R.id.btnn3, "Electricity", "Full Home Setup",      "₹1,999")
